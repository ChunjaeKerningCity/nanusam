...
<main class="marginTop">
    <div class="commonContainer">
        ...
        <div class="commonMain">
            <div>
                <form action="/goods/modify.do?idx=${item.idx}" method="post" name="frmGoodsRegist" id="frmGoodsRegist"
                            ...
                            <select name="category" id="category" class="form-select"
                                ...
                                <c:forEach items="${categories}" var="category">
                                    <option value="${category.code}"
                                            <c:if test="${item.category==category.code}">selected</c:if> >${category.value}</option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <ul>
                                    <li id="fileorg">
                                        <input style="display:none;" type="checkbox" name="deleteFile" id="orgMainImage"
                                               value="${orgMainImage.fileName}" onchange="toggleDelete('org')">
                                        <span>${orgMainImage.orgFileName}</span> <label style="display: inline;"
                                                                                        for="orgMainImage">x</label>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="content" name="content" rows="3"
                                  placeholder="상품 설명">${item.content}</textarea>
                    </div>
