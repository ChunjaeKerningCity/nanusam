<%@ page contentType="text/html;charset=UTF-8" language="java" %> <%@ page
    trimDirectiveWhitespaces="true" %> <%@ taglib prefix="c"
                                                  uri="http://java.sun.com/jsp/jstl/core" %> <%@ taglib prefix="fn"
                                                                                                        uri="http://java.sun.com/jsp/jstl/functions"%> <% String replaceChar = "\n";
    request.setAttribute("replaceChar", replaceChar);%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
...
<header class="center">
    ...
    />
    <c:import
        url="/WEB-INF/views/commonArea/headerSearchArea.jsp"
        charEncoding="UTF-8"
    />
    <c:import
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <!-- 본문 내용 -->
                <div class="content">
                    ${fn:replace(dto.content, replaceChar,"<br />")}
                </div>
                ...
                <div class="form-group row justify-content-center mt-3">
                    <div class="col">
                        <button
                            type="button"
                            class="btnModify"
                            onclick="javascript:location.href='/bbs/modify.do?idx=${dto.idx}'"
                        >
                            수정
                        </button>
                        <button
                            type="button"
                            class="btnDelete"
                            onclick="javascript:location.href='/bbs/delete.do?idx=${dto.idx}'"
                        >
                            삭제
                        </button>
                    </div>
