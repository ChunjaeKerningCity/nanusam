...
<main>
    <div class="card-body">
        <form action="/bbs/modify.do?idx=${dto.idx}" method="post" class="form-container">
            <!-- 제목 입력 -->
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="title">제목</span>
                </div>
                <input style="width: 80%" type="text" class="form-control" name="title" aria-describedby="basic-addon1" value="${dto.title}" required>
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input style="width: 80%" type="text" class="form-control" name="memberId" aria-describedby="basic-addon1" value="${dto.memberId}" readonly>
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <textarea style="width: 80%" class="form-control" name="content" aria-label="content" required>${dto.content}</textarea>
            </div>
